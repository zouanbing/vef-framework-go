...
// If no timeout is provided or timeout is zero, a default timeout of 5 seconds is used.
// This is higher than Fiber's default (1s) to accommodate CI environments.
