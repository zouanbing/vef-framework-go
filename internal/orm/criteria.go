...
func (cb *CriteriaBuilder) auditUserCompare(addFn func(string, ...any), op, col, value string, alias ...string) {
...
func (cb *CriteriaBuilder) auditUserCompareCurrent(addFn func(string, ...any), op, col string, alias ...string) {
	addFn("? ? ?Operator", buildColumnExpr(col, alias...), bun.Safe(op))
}

// auditUserIn adds an IN/NOT IN condition for an audit user column.
func (cb *CriteriaBuilder) auditUserIn(addFn func(string, ...any), op, col string, values []string, alias ...string) {
...
func (cb *CriteriaBuilder) auditTimestampCompare(addFn func(string, ...any), op, col string, t time.Time, alias ...string) {
